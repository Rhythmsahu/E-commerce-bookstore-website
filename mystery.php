...
<html>
    <head>
        <title>Buy Books of Genre Mystery</title>
  ...
  <script
    ...
    <div id="login-box" class="animate">
      ...
      <div class="left-box">
        <h1> Login </h1>
        <form method="post" action="mystery.php">
      ...
      <div class="jumbotron jumbotron-fluid" style="background:url('img/MysteryBanner.jpg')">
        </div>
...
<?php
  ...
  $query="SELECT * FROM dashboard1 WHERE genre='mystery'";
