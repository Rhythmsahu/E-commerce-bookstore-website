...
<html>
    <head>
        <title>Buy Books of Genre Science and Technology</title>
  ...
  <script
    ...
    <div id="login-box" class="animate">
      ...
      <div class="left-box">
        <h1> Login </h1>
        <form method="post" action="sci_tech.php">
      ...
      <div class="jumbotron jumbotron-fluid" style="background:url('img/scitechBanner.jpg')">
                <h1 id="head-text">Science and Technology</h1><br><br>
                <p id="second-text">"Science of Today is the Technology of Tomorrow"</p>
        </div>
...
<?php
  ...
  $query="SELECT * FROM dashboard1 WHERE genre='sci-tech'";
