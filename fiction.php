...
<html>
    <head>
        <title>Buy Books of Genre Fiction</title>
  ...
  <script
    ...
    <div id="login-box" class="animate">
      ...
      <div class="left-box">
        <h1> Login </h1>
        <form method="post" action="fiction.php">
      ...
      <div class="jumbotron jumbotron-fluid">
          <img src="img/Fictionbanner.jpg" style="height: 400px;width:1400px;">
                <!--<h1 id="head-text">FICTION......</h1><br><br>
...
<?php
  ...
  $query="SELECT * FROM dashboard1 WHERE genre='fiction'";
