...
<html>
    <head>
        <title>Buy Books of Genre Horror-Fiction</title>
  ...
  <script
    ...
    <div id="login-box" class="animate">
      ...
      <div class="left-box">
        <h1> Login </h1>
        <form method="post" action="horror_fiction.php">
      ...
      <?php endif; ?> 
        ...
        <div class="jumbotron jumbotron-fluid" style="background:url('img/HorrorBanner.jpg')">
                <h1 id="head-text">HORROR-FICTION......</h1><br><br>
                <p id="second-text">"Horror is Beyond the Reach of Psychology"</p>
        </div>
...
<?php
  ...
  $query="SELECT * FROM dashboard1 WHERE genre='horror'";
