...
<html>
    <head>
        <title>Buy Books of Genre Non-Fiction</title>
  ...
  <script
    ...
    <div id="login-box" class="animate">
      ...
      <div class="left-box">
        <h1> Login </h1>
        <form method="post" action="non_fiction.php">
      ...
      <div class="jumbotron jumbotron-fluid" style="background:url('img/NfictionBanner.jpg')">
                <h1 id="head-text">NON-FICTION......</h1><br><br>
                <p id="second-text">"Because In dreams We Enter a World That Is Completely Our Own"</p>
                <a class="btn btn-primary btn-lg" href="#first_book" role="button">Browse Books</a>
        </div>
...
<?php
  ...
  $query="SELECT * FROM dashboard1 WHERE genre='non-fiction'";
