...
<html>
    <head>
        <title>Buy Books of Genre Science-Fiction</title>
  ...
  <script
    ...
    <div id="login-box" class="animate">
      ...
      <div class="left-box">
        <h1> Login </h1>
        <form method="post" action="sci_fi.php">
      ...
      <div class="jumbotron jumbotron-fluid" style="background:url('img/scifibanner.jpg')">
                <h1 id="head-text">Science Fiction</h1><br><br>
                <p id="second-text">"I Define Science Fiction as the Art of Possible.<br><br>Fantasy is the Art of Impossible."</p>
        </div>
...
<?php
  ...
  $query="SELECT * FROM dashboard1 WHERE genre='sci-fiction'";
