...
<html>
    <head>
        <title>Buy Books of Genre Children Literature</title>
  ...
  <script
    ...
    <div id="login-box" class="animate">
      ...
      <div class="left-box">
        <h1> Login </h1>
        <form method="post" action="children_literature.php">
      ...
      <div class="jumbotron jumbotron-fluid" style="background:url('img/childrenBanner.png')">
...
<?php
  ...
  $query="SELECT * FROM dashboard1 WHERE genre='children'";
